                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-6 text-center">
                            <img src="<?= base_url('assets/'); ?>learnit/img/modal-login-2.png"
...
<script src="<?= base_url('assets/') ?>learnit/js/stellar.js"></script>
<script src="<?= base_url('assets/') ?>learnit/vendors/lightbox/simpleLightbox.min.js"></script>
<script src="<?= base_url('assets/') ?>learnit/vendors/nice-select/js/jquery.nice-select.min.js"></script>
<script src="<?= base_url('assets/') ?>learnit/vendors/isotope/imagesloaded.pkgd.min.js"></script>
<script src="<?= base_url('assets/') ?>learnit/vendors/isotope/isotope.pkgd.min.js"></script>
<script src="<?= base_url('assets/') ?>learnit/vendors/owl-carousel/owl.carousel.min.js"></script>
<script src="<?= base_url('assets/') ?>learnit/vendors/popup/jquery.magnific-popup.min.js"></script>
<script src="<?= base_url('assets/') ?>learnit/js/jquery.ajaxchimp.min.js"></script>
<script src="<?= base_url('assets/') ?>learnit/vendors/counter-up/jquery.waypoints.min.js"></script>
<script src="<?= base_url('assets/') ?>learnit/vendors/counter-up/jquery.counterup.js"></script>
<script src="<?= base_url('assets/') ?>learnit/js/mail-script.js"></script>
<script src="<?= base_url('assets/') ?>learnit/js/theme.js"></script>
<script>
