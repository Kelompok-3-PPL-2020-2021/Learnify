...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/') ?>leranit/vendors/linericon/style.css">
    <link rel="stylesheet" href="<?= base_url('assets/') ?>learnit/css/font-awesome.min.css">
    <link rel="stylesheet" href="<?= base_url('assets/') ?>leranit/vendors/owl-carousel/owl.carousel.min.css">
    <link rel="stylesheet" href="<?= base_url('assets/') ?>leranit/vendors/lightbox/simpleLightbox.css">
    <link rel="stylesheet" href="<?= base_url('assets/') ?>leranit/vendors/nice-select/css/nice-select.css">
    <link rel="stylesheet" href="<?= base_url('assets/') ?>leranit/vendors/animate-css/animate.css">
    <link rel="stylesheet" href="<?= base_url('assets/') ?>leranit/vendors/popup/magnific-popup.css">
    <!-- main css -->
