                ...
                <div class="row">
                    <div class="col-sm-4 mb-2 d-flex justify-content-center " data-aos-duration="1900"
                        ...
                        <a href="<?= base_url('user/kelas10') ?>">
                            <div class="card-kelas text-center">
                                <img src="<?= base_url('assets/') ?>learnit/img/kelas10.png" style="object-fit: cover;"
                    ...
                    <div class="col-sm-4 mb-2 d-flex justify-content-center " data-aos-duration="1900"
                        ...
                        <a href="<?= base_url('user/kelas11') ?>">
                            <div class="card-kelas">
                                <img src="<?= base_url('assets/') ?>learnit/img/kelas11.png" class="card-img-top"
                                    alt="...">
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-4 mb-2 d-flex justify-content-center" data-aos-duration="1900"
                        ...
                        <a href="<?= base_url('user/kelas12') ?>">
                            <div class="card-kelas">
                                <img src="<?= base_url('assets/') ?>learnit/img/kelas12.png" class="card-img-top"
                                    alt="...">
                            </div>
                        </a>
                    </div>
